  ...
  <div class="col-md-12">
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <table class="table table-bordered table-striped table-hover custom_table" id="alltableinfo">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="#" id="restore" data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{$data->expcate_id}}"><i class="fas fa-recycle fs-5 text-success fw-bold"></i></a>
                <a href="#" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$data->expcate_id}}"><i class="fas fa-trash fs-5 text-danger fw-bold ms-2"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
