      ...
      <div class="card mb-3">
        <div class="card-header">
          <div class="row">
            <div class="col-md-8 card_title_part">
              <i class="fab fa-gg-circle"></i>Update User
            </div>
        ...
        <div class="card-body">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-2">
              @if($data->photo!='')
              <img height="100" src="{{asset('uploads/users/'.$data->photo)}}" alt="User">
              @else
              <img height="100" src="{{asset('contents/admin')}}/images/avatar.png">
              @endif
            </div>
          </div>
        </div>
